...
class _VPixelInherited extends InheritedWidget {
  ...
  final Widget child;
  final Key key;
  const _VPixelInherited({this.key, this.data, this.child}) : super(key: key, child: child);
  @override
...
class VPixel extends StatefulWidget {
  ...
  const VPixel({this.key, this.builder, this.designWidth}) : assert(designWidth != null), super(key: key);
  @override
